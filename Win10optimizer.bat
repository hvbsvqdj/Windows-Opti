...
REM  ********** Options
REM 1-Desactivation autoupdate,2-Demande pour telecharger et installer, 3-Demande pour Reboot, 4-automatic update
SET AutoUpdateN=2

REM Si votre systeme est sur SSD drive - set 0, HDD - 3
SET Prefetch=0

REM Nom du PC
SET MyComputerName=MiDooM
